...
export class ValorizacionMineral extends Auditoria {
  ...
  // Solo aplica a codificaciones que descuentan humedad antes de la merma
  // (ej. BCL: PSB = PHB - H2O). Otras codificaciones no lo usan y queda null.
  @Column({
    name: 'peso_bruto_seco_kilogramos',
    type: 'numeric',
    precision: 15,
    scale: 5,
    nullable: true,
  ...
  @Column({
    name: 'total_valor_liquido_venta_bolivianos',
    type: 'numeric',
    precision: 14,
    scale: 2,
    default: 0,
  ...
  @Column({
    name: 'total_valor_liquido_venta_usd',
    type: 'numeric',
    precision: 14,
    scale: 2,
    nullable: true,
