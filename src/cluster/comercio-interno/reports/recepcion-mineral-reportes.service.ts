...
export class RecepcionMineralReportesService {
  ...
  async anticipoVsLiquidado(filtros: FiltroReporteAnticiposDto) {
    ...
    const query = this.recepcionRepository
      ...
      .andWhere('valorizacion.totalValorBrutoBolivianos IS NOT NULL');
    ...
    const expresionDiferencia =
      'valorizacion.totalValorBrutoBolivianos - COALESCE(recepcion.anticipo, 0)';
    ...
    query
      ...
      .addSelect('valorizacion.totalValorBrutoBolivianos', 'valorLiquidado')
